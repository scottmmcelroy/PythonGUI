...
def buttonPress():
    ...
    if fsw.get() == "":
        ...
        sendApproved = False
    elif int(float(fsw.get())) >= 0 and 20000 >= int(float(fsw.get())):
        ...
        addText("**Please input a VALID switching frequency between between 0-20kHz!**")
        sendApproved = False
    #######    
...
####Main Start######
    ...
    note_label = ttk.Label(root, text="(0-20kHz)", foreground='white', background="black", font=('San Serif Pro', 12))
